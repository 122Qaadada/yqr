...
function SideRays({
  ...
  useEffect(() => {
    if (!isVisible || !isPageVisible || !containerRef.current) return undefined;
...
void main() {
  ...
  gl_FragColor = color;
      ...
      const updateSize = () => {
        ...
        renderer.dpr = Math.min(window.devicePixelRatio, 1.35);
      ...
      cleanupFunctionRef.current = () => {
        ...
        try {
          ...
          // WebGL cleanup is best-effort across browser implementations.
        }
